...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Toggle buttons positioned in top left
- [x] #2 Clear visual distinction between Attract and Repel
- [x] #3 Active mode highlighted with accent color
- [x] #4 Hover and click states for buttons
- [x] #5 Buttons don't obstruct main content
- [x] #6 Accessible with proper ARIA labels
- [x] #7 Attract Mode button positioned top left
- [x] #8 Glassmorphism style: rgba(255,255,255,0.05) bg, blur(10px)
- [x] #9 Teal accent (#14B8A6) for active state
- [ ] #10 Hide Camera button below Attract Mode
- [x] #11 Icon + text labels (magnet icon for attract)
- [x] #12 Hover and click states with smooth transitions
<!-- AC:END -->
