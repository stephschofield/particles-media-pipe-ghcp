...
Set up the foundational project structure using Next.js App Router, TypeScript in strict mode, and Tailwind CSS for styling. Configure ESLint and Prettier for code quality.
